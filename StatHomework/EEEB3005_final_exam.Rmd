...
Since $b$ is positive, so the small stock dies with lower porbability, which means they survive better.
...
dens(logistic(samples.2$a), col = 'red', xlab = 'Red: Samll,  Blue: Large')
...
Conversely, for large stocks, the difference of herd size among herds is not so large, which makes the mortality slightly lower than small stock.
